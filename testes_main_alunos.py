...
class TestObterResposta(unittest.TestCase):
    ...
    def teste_despedidas(self):
        ...
        self.assertEqual(
            obter_resposta("adeus"), "Gostei de falar contigo! Até breve..."
        )
        self.assertEqual(
            obter_resposta("tchau"), "Gostei de falar contigo! Até breve..."
        )

    def teste_historia_portugal(self):
        """Teste de respostas sobre história de Portugal - 1 teste"""
        self.assertEqual(
            obter_resposta("historia de portugal"), "Portugal tem uma rica história..."
        )
    ...
    def teste_cozinhar(self):
        ...
        self.assertEqual(
            ...
            "Cozinhar é uma arte que envolve a preparação de alimentos...",
        )
    ...
    def teste_desenvolvimento(self):
        ...
        self.assertEqual(
            obter_resposta("desenvolvimento de software"),
            "O desenvolvimento de software é o processo de criar programas e aplicações...",
        )
        self.assertEqual(
            obter_resposta("desenvolvimento de jogos"),
            "O desenvolvimento de jogos é a criação de jogos eletrônicos...",
        )
        self.assertEqual(
            obter_resposta("desenvolvimento de aplicativos móveis"),
            "O desenvolvimento de aplicativos móveis é a criação de aplicativos para dispositivos móveis...",
        )
    ...
    def teste_horas_e_data(self):
        ...
        self.assertTrue(obter_resposta("que horas são").startswith("São: "))
        self.assertTrue(obter_resposta("qual é a data").startswith("Hoje é dia: "))

        self.assertIn(":", obter_resposta("horas"))
        self.assertRegex(obter_resposta("data"), r"\d{2}-\d{2}-\d{4}")
